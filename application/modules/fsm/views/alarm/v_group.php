                                        ...
                                        if($datagroup){
                                            foreach ($datagroup as $v) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-success" href="'<?php echo base_url(); ?>storefront/report/SettAlarm/<?php echo $v->id; ?>'" title="Edit"><i class="material-icons add"></i> New Member</a>
                                                        <a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_person('<?php echo $v->id; ?>')"><i class="material-icons edit-icon"></i> Edit</a>
                                                        <a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_person('<?php echo $v->id; ?>')"><i class="material-icons delete"></i> Delete</a>
                                                    </td>                                                    
                                                </tr>
                                                <?php
                                            }
        ...
        <script>
           ...
           function delete_person(id)
           {
               if(confirm('Are you sure delete this data?'))
               {
                   ...
                   $.ajax({
                       url : "<?php echo site_url('storefront/alarm/ajax_delete')?>/"+id,
                       type: "POST",
                       dataType: "JSON",
                       success: function(data)
                       {
