<table width="585px" border="0" style="border-spacing: 50px 30px;">
  <tbody>
    <tr>
      <td width="10%"><center>
        <p style="font-weight: bold">FT INTAKE 3</p>
      ...
      <td width="10%"><center>
        <p style="font-weight: bold">FT INTAKE3 (Σ)</p>
        <div style="max-width:220px; width:100%; margin:0 padding:20px;">
	 ...
	 <tr>
      <td width="10%"><center>
        <p style="font-weight: bold">PI 301</p>
        <div style="max-width:140px; width:100%; margin:0 padding:20px;">
          <table class="tabBlock" align="right" cellspacing="0" cellpadding="0" border="0">
            <tr>
              <!-- <td class="clock" id="ds_val14"></td> -->
			  <img id="ds_val14" style="width:100%;" src = "http://122.129.112.169/agus/Office/images/on.png">
            </tr>
          </table>
        </div>
      </center></td>
      <td width="10%"><center>
        <p style="font-weight: bold">PI 302</p>
        <div style="max-width:140px; width:100%; margin:0 padding:20px;">
          <table class="tabBlock" align="left" cellspacing="0" cellpadding="0" border="0">
            <tr>
              <!-- <td class="clock" id="ds_val15"></td> -->
			  <img id="ds_val15" style="width:100%;" src = "http://122.129.112.169/agus/Office/images/on.png">
            </tr>
          </table>
        </div>
      </center></td>
