...
class Googlemaps {
	...
	var $apiKey                             = 'AIzaSyD1ZXUgR6tKkalCRpqNe6QeNvtvxvy1qmA'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
