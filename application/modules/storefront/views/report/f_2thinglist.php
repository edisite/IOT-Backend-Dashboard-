<link href="<?php echo base_url(); ?>plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css" rel="stylesheet" />
    ...
    <!--                                        <label class="form-label">Pilih Date</label>-->
                                    ...
                                    <button class="btn btn-primary waves-effect" type="submit" name="btnsubmit" id="btnsubmit">Search</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="row clearfix">
                <div class='col-lg-6 col-md-6 col-sm-12 col-xs-12'>
                    <div class='card'>
                        <div class='body'>
                            <div id='Line2Sensor' style='height: 400px;'></div>
                        </div>
                    </div>
                </div>
                <div class='col-lg-6 col-md-6 col-sm-12 col-xs-12'>
                    <div class='card'>
                        <div class='body'>
                            <div id='Bar2Sensor' style='height: 400px;'></div>
                        </div>
                    </div>
                </div>
            </div>
