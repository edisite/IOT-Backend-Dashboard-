                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        <div class="form-group form-float">
                            <div class="form-line" >                                            
                                <input type="text" id="datetimepicker1" name="datetimes1" class="datetimepicker form-control" value="">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-float">
                            <div class="form-line">                                            
                                <input type="text" name="datetimes2" class="datetimepicker form-control" value="" />
                    ...
                    <div class="col-md-12">                        
                        <div class="irs-demo">
                            <input type="text" id="range_02" name="tvalue" value="" />    
                            <label class="form-label">Value</label>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                               <button class="btn btn-primary waves-effect pull-right" type="submit" name="btnsubmit" id="btnsubmit">Search</button>
                        </div>
                    </div>
