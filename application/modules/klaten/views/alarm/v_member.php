                            ...
                            if($datagroup){
                                foreach ($datagroup as $v) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href='<?php echo base_url(); ?>storefront/report/AlmCreateMember_del/<?php echo $v->idmember; ?>'><i class="material-icons">delete</i></a>
                                            <a href='<?php echo base_url(); ?>storefront/report/AlmCreateMember_edit/<?php echo $v->idmember; ?>/1'><i class="material-icons">edit</i></a>
